...
export const CAR_PATTERN_OPTIONS = [
  ...
  },
  {
    ...
    mode: "car",
    label: "전기차",
    description: "전기차 약 0.044kg CO₂/km 적용",
    kgPerKm: 0.044,
  },
] as const;
